...
let initialOrders = [
  { id: 1, orderId: 'ORD001', customerName: 'Sravan', orderDate: '2024-03-15', status: 'Pending', expectedDeliveryDate: new Date() },
  { id: 2, orderId: 'ORD002', customerName: 'Siddartha', orderDate: '2024-03-16', status: 'Processing', expectedDeliveryDate: new Date() },
  { id: 3, orderId: 'ORD003', customerName: 'Venu Gopal', orderDate: '2024-03-17', status: 'Delivered', expectedDeliveryDate: new Date() },
  { id: 4, orderId: 'ORD004', customerName: 'Manideep', orderDate: '2024-03-15', status: 'Pending', expectedDeliveryDate: new Date() }
];
